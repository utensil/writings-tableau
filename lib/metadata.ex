# This file is adapted from https://github.com/paradox460/pdx.su/blob/main/lib/metadata.ex

defmodule Writings.Metadata do
...
defmodule Writings.Metadata.Config do
